...
router.post('/admin/shop/config', requireAdmin(2), (req, res) => {
  ...
  if (sms_poll_strategy   !== undefined) updates['sms_poll_strategy']   = ['least','sequential'].includes(sms_poll_strategy)   ? sms_poll_strategy   : 'least';
  if (email_poll_strategy !== undefined) updates['email_poll_strategy'] = ['least','sequential'].includes(email_poll_strategy) ? email_poll_strategy : 'least';
  if (kyc_poll_strategy   !== undefined) updates['kyc_poll_strategy']   = ['least','sequential'].includes(kyc_poll_strategy)   ? kyc_poll_strategy   : 'least';
