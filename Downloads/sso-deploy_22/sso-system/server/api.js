...
const defaultConfigs = {
  ...
  'redeem_code_on':   '1',     // 兑换码功能开关
  'kyc_cost_type':    'free',  // 实名认证消耗方式: free | points | redeem_code
  'kyc_cost_value':   '0',     // 消耗积分数量（type=points 时有效）
  'kyc_feature_key':  'kyc',   // type=redeem_code 时对应的 feature_key
};
