# QWQ SSO — 统一登录系统 v3.4.12.1

> 多渠道登录 · 用户/管理控制台 · 积分商城 · KYC 实名认证 · 开放 API · OIDC 身份提供方

[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)
[![Version](https://img.shields.io/badge/version-3.4.12.1-blue.svg)](https://github.com/uesrbai/qwq-sso)
...
所有接口以 `Bearer sk_live_xxxx` 或 `Bearer sk_test_xxxx` 鉴权，共 27 个 `/v1/*` 接口，按 scope 授权。
