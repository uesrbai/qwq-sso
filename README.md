# QWQ SSO — 统一登录系统 v3.4.14

> 多渠道登录 · 用户/管理控制台 · 积分商城 · KYC 实名认证 · 开放 API · OIDC 身份提供方

[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)
[![Version](https://img.shields.io/badge/version-3.4.14-blue.svg)](https://github.com/uesrbai/qwq-sso)
...
> **多主体（多组织 / 多架构）**：每个渠道除环境变量配的「默认主体」外，还可在管理端「登录主体」里挂任意多个额外主体（如微信下挂 A 公司、B 公司两套 AppID/Secret/回调），登录页与账号绑定页会分别列出，互不干扰。
...
所有接口以 `Bearer sk_live_xxxx` 或 `Bearer sk_test_xxxx` 鉴权，共 28 个 `/v1/*` 接口，按 scope 授权。
